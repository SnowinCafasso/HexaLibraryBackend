...
public class EmployeeServiceImpl implements EmployeeService {
    ...
    public void deleteEmployeeById(int empId) {
        ...
        // Detach branch relationship to avoid constraint error
        employee.setBranch(null);
        empRepo.save(employee); // Update the employee with null branch

        // Delete the associated AuthUser
        authUserRepo.findByUserIdAndUserType((long) empId, "employee")
            .ifPresent(authUserRepo::delete);

        // Now safely delete employee
